...
public class TaskTest {
    ...
    public void setUp() {
        ...
        d1 = new Deliverable("Deliverable1", "Deliverable1", 1.25, 1999, 2.33, Calendar.getInstance());
        d2 = new Deliverable("Deliverable2", "Deliverable2", 1.0, 401, 1.0, Calendar.getInstance());
        d3 = new Deliverable("Deliverable3", "Deliverable3", 1.0, 2, 5.5, Calendar.getInstance());
    ...
    public void testGetCostEstimate() {
        assertEquals("Task.getCostEstimate() should return the costs of all Deliverables!",2408, t1.getCostEstimate(), 0.0001);
