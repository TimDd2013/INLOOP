...
public class AppointeeTest {
    ...
    @Test
    public void testConstructorInvalidDayOfMonth() {
        try {
            new Appointee("Martin", -1, 1, 1);
            fail("Appointee.Appointee() should throw an IllegalArgumentException if the dayOfMonth argument is invalid!");
    ...
    @Test
    public void testConstructorValidDayOfMonth() {
        try {
            for (int i = 1; i < 32; i++) {
                new Appointee("Martin", i, 1, 1);
            }
        } catch (IllegalArgumentException e) {
            fail("Appointee.Appointee() should not throw an IllegalArgumentException if the dayOfMonth argument is valid!");
        }
    }
