...
public class PredicateIteratorTest {
    ...
    public void setUp() {
        ...
        preditsw = new PredicateIterator<String>(testList.iterator(), new PredicateStartsWith<String>(), "T");
    }
    ...
    public void testNoElementsToProvide() {
        ...
        testList.add("West");
        testList.add("East2");
        preditsw = new PredicateIterator<String>(testList.iterator(), new PredicateStartsWith(), "T");
